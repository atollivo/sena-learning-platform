...
| :--- | :--- | :--- |
| [Nombre del Aprendiz 1] | Brayan Steven Villota Diaz | `@atollivo` |
| [Nombre del Aprendiz 2] | Brayan Steven Villota Diaz | `@atollivo` |
| [Nombre del Aprendiz 3] | Brayan Steven Villota Diaz| `@atollivo` |
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos todos los días 
...
* **Prohibido el "Push" a Main:** Nadie, bajo ninguna circunstancia, subirá código directamente a `main` sin pasar por un Pull Request.
